...
abstract class AppLocalizations {
  ...
  /// No description provided for @counterMainTip.
  ///
  /// In en, this message translates to:
  /// **'You have pushed the button this many times:'**
  String get counterMainTip;

  /// No description provided for @animalImagePageTitle.
  ///
  /// In en, this message translates to:
  /// **'Animal Image'**
  String get animalImagePageTitle;
  ...
  /// No description provided for @loadingOrParsingErrorTitle.
  ///
  /// In en, this message translates to:
  /// **'Loading or Parsing Error'**
  String get loadingOrParsingErrorTitle;

  /// No description provided for @loadingOrParsingErrorSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Oops, something went wrong.'**
  String get loadingOrParsingErrorSubtitle;
  ...
  /// No description provided for @momentsPageTitle.
  ///
  /// In en, this message translates to:
  /// **'Moments'**
